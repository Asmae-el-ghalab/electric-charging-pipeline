...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 05 juin 2026 à 17:43
...
CREATE TABLE `conducteur` (
  ...
  `type_prise` enum('CCS','CHADEMO','SCHUKO','TYPE2') DEFAULT NULL,
...
INSERT INTO `conducteur` (`est_bloque`, `type_prise`, `vehicule`, `id`) VALUES
(b'0', NULL, 'fait 77', 1),
(b'0', NULL, 'fait 77', 2);
...
(475, 471457, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(476, 471455, 'CCS (Type 2)', 50, 2, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(477, 471453, 'CCS (Type 2)', 50, 2, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(478, 460398, 'CCS (Type 2)', 180, 2, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(479, 460398, 'CCS (Type 2)', 40, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(480, 460244, 'CCS (Type 2)', 100, 2, 400, 200, 'Level 3:  High (Over 40kW)', 'DC'),
(481, 314010, 'CCS (Type 2)', 100, 2, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(482, 314010, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(483, 313957, 'CCS (Type 2)', 50, 2, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(484, 313956, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(485, 313956, 'Type 2 (Tethered Connector) ', 7, 4, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(486, 313652, 'CCS (Type 2)', 100, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(487, 313652, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(488, 312704, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(489, 312704, 'Type 2 (Tethered Connector) ', 43, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'AC (Three-Phase)'),
(490, 311791, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(491, 311621, 'Type 2 (Tethered Connector) ', 2, 1, NULL, NULL, 'Level 1 : Low (Under 2kW)', 'AC (Three-Phase)'),
(492, 311620, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(493, 311618, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(494, 311617, 'Type 2 (Tethered Connector) ', 22, 1, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(495, 311616, 'Type 2 (Tethered Connector) ', 22, 2, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(496, 311517, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(497, 311516, 'Type 2 (Tethered Connector) ', 11, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(498, 311515, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(499, 311514, 'Type 2 (Tethered Connector) ', 22, 4, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(500, 311513, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(501, 311513, 'CHAdeMO', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(502, 311512, 'Type 2 (Tethered Connector) ', 22, 4, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(503, 311511, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(504, 311510, 'Type 2 (Tethered Connector) ', 22, 3, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(505, 311468, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(506, 311468, 'CHAdeMO', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(507, 311467, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(508, 311467, 'CHAdeMO', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(509, 311467, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(510, 311412, 'Type 2 (Tethered Connector) ', 22, 2, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(511, 311380, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(512, 311376, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(513, 311375, 'CCS (Type 2)', 240, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(514, 311375, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(515, 311375, 'CCS (Type 2)', 360, 3, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(516, 311374, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(517, 311374, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(518, 311372, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(519, 311371, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(520, 311370, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(521, 311370, 'Type 2 (Tethered Connector) ', 43, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'AC (Three-Phase)'),
(522, 311368, 'CCS (Type 2)', 100, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(523, 311368, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(524, 311367, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(525, 311367, 'CHAdeMO', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(526, 311367, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(527, 311366, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(528, 311365, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(529, 311364, 'Type 2 (Tethered Connector) ', 22, 2, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(530, 311363, 'Type 2 (Tethered Connector) ', 22, 2, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(531, 311362, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(532, 311362, 'Type 2 (Tethered Connector) ', 22, 1, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(533, 311310, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(534, 311310, 'CHAdeMO', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(535, 311310, 'Type 2 (Tethered Connector) ', 22, 1, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(536, 311309, 'CCS (Type 2)', 100, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(537, 311309, 'Type 2 (Tethered Connector) ', 22, 3, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(538, 311307, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(539, 311307, 'Type 2 (Tethered Connector) ', 43, 1, 400, 63, 'Level 3:  High (Over 40kW)', 'AC (Three-Phase)'),
(540, 311306, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(541, 311306, 'Type 2 (Tethered Connector) ', 43, 1, 400, 63, 'Level 3:  High (Over 40kW)', 'AC (Three-Phase)'),
(542, 311298, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(543, 311298, 'Type 2 (Tethered Connector) ', 22, 1, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(544, 311283, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(545, 311283, 'Type 2 (Tethered Connector) ', 43, 1, 400, 63, 'Level 3:  High (Over 40kW)', 'AC (Three-Phase)'),
(546, 311274, 'CCS (Type 2)', 100, 2, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(547, 311274, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(548, 311272, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(549, 311272, 'CHAdeMO', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(550, 302531, 'CCS (Type 2)', 150, 4, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(551, 302530, 'CCS (Type 2)', 150, 4, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(552, 302529, 'CCS (Type 2)', 150, 4, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(553, 302528, 'CCS (Type 2)', 150, 4, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(554, 302527, 'CCS (Type 2)', 150, 4, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(555, 302526, 'CCS (Type 2)', 150, 4, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(556, 300176, 'Type 2 (Tethered Connector) ', 22, 4, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(557, 290232, 'Type 2 (Tethered Connector) ', 22, 1, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(558, 274172, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(559, 274076, 'Type 2 (Tethered Connector) ', 22, 1, 230, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(560, 273999, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(561, 266658, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(562, 266634, 'CCS (Type 2)', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(563, 266634, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(564, 266634, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(565, 266542, 'CCS (Type 2)', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(566, 266542, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(567, 266542, 'Type 2 (Tethered Connector) ', 22, 2, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(568, 266542, 'CCS (Type 2)', 100, 2, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(569, 266533, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(570, 266533, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(571, 266533, 'CCS (Type 2)', 50, 1, 1000, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(572, 266532, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(573, 266532, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(574, 266532, 'CCS (Type 2)', 50, 1, 1000, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(575, 266532, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(576, 266531, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(577, 266531, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(578, 266531, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(579, 266531, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(580, 266516, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(581, 266516, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(582, 266515, 'Type 2 (Tethered Connector) ', 22, 3, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(583, 266515, 'CCS (Type 2)', 50, 2, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(584, 266459, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(585, 266428, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(586, 266428, 'CCS (Type 2)', 50, 2, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(587, 265402, 'CCS (Type 2)', 180, 2, 1000, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(588, 260102, 'Type 2 (Tethered Connector) ', 22, 2, 230, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(589, 259608, 'Type 2 (Tethered Connector) ', 22, 2, 230, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(590, 258410, 'Type 2 (Socket Only)', 22, 4, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(591, 258409, 'Type 2 (Tethered Connector) ', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(592, 238035, 'Type 2 (Tethered Connector) ', 22, 2, 230, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(593, 235594, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(594, 235593, 'Type 2 (Tethered Connector) ', 22, 2, 230, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(595, 211233, 'CCS (Type 2)', 50, 1, 1000, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(596, 211233, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(597, 211233, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(598, 211233, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(599, 211233, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(600, 211232, 'CCS (Type 2)', 50, 1, 1000, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(601, 211232, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(602, 211231, 'Type 2 (Socket Only)', 22, 2, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(603, 211230, 'Type 2 (Socket Only)', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(604, 211230, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(605, 211229, 'CCS (Type 2)', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(606, 211229, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(607, 211229, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(608, 211228, 'Type 2 (Socket Only)', 22, 2, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(609, 211227, 'CCS (Type 2)', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(610, 211227, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(611, 211227, 'Type 2 (Tethered Connector) ', 22, 1, 500, 125, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(612, 211226, 'CCS (Type 2)', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(613, 211226, 'CHAdeMO', 50, 1, 500, 125, 'Level 3:  High (Over 40kW)', 'DC'),
(614, 211226, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(615, 208638, 'Type 2 (Socket Only)', 11, 1, 400, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(616, 207017, 'Type 2 (Tethered Connector) ', 22, 1, 230, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(617, 207017, 'CCS (Type 2)', 30, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(618, 207016, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(619, 204326, 'Type 2 (Tethered Connector) ', 22, 2, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(620, 204325, 'Type 2 (Tethered Connector) ', 22, 2, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(621, 204324, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(622, 204323, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(623, 204323, 'Type 2 (Tethered Connector) ', 22, 1, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(624, 204322, 'Type 2 (Tethered Connector) ', 22, 2, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(625, 194317, 'Type 2 (Tethered Connector) ', 22, 2, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(626, 193723, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(627, 193606, 'Type 2 (Tethered Connector) ', 22, 1, 230, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(628, 193605, 'Type 2 (Tethered Connector) ', 22, 2, 230, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(629, 192300, 'Type 2 (Tethered Connector) ', 22, 2, 380, 32, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)'),
(630, 191005, 'CCS (Type 2)', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(631, 191005, 'CHAdeMO', 50, 1, NULL, NULL, 'Level 3:  High (Over 40kW)', 'DC'),
(632, 191005, 'Type 2 (Tethered Connector) ', 22, 1, NULL, NULL, 'Level 2 : Medium (Over 2kW)', 'AC (Three-Phase)');
...
CREATE TABLE `favori` (
  `id` bigint(20) NOT NULL,
  `borne_id` bigint(20) DEFAULT NULL,
  `conducteur_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `signalement` (
  `id` bigint(20) NOT NULL,
  `date_signalement` datetime(6) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `statut` enum('EN_ATTENTE','REJETE','RESOLU') DEFAULT NULL,
  `type` enum('AUTRE','INDISPONIBLE','PANNE','VANDALISME') DEFAULT NULL,
  `borne_id` bigint(20) DEFAULT NULL,
  `conducteur_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `stations` (
  ...
  `usage_cost` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `utilisateur` (
  ...
  `role` enum('ADMIN','CONDUCTEUR') DEFAULT NULL,
  ...
  `type_prise` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `utilisateur` (`id`, `date_inscription`, `email`, `mot_de_passe`, `nom`, `role`, `dtype`, `vehicule`, `derniere_connexion`, `niveau_acces`, `est_bloque`, `type_prise`) VALUES
(1, '2026-06-03 11:49:16.000000', 'soukainaessabiri0165@gmail.com', '$2a$10$TLtCY1PTOASZf1V/NHATA.2UOXEycrR83SVZ0e2uqRrj.4EjK5zTi', 'Dupont', 'CONDUCTEUR', NULL, NULL, '2026-06-05 10:38:26', NULL, 0, NULL),
(2, '2026-06-03 12:08:34.000000', 'soukainaessabiri016@gmail.com', '$2a$10$2eVic148mMUcQhT5FYG6juBhkiuiL2EyfISgt9NlKLSlgQT2T6Sxm', 'Dupont', 'CONDUCTEUR', NULL, NULL, '2026-06-05 10:38:26', NULL, 0, NULL),
(3, '2026-06-05 10:39:20.000000', 'soukainaessabiri001@gmail.com', '$2a$10$k6ttc36ZdWCqk/UFrUSptOeMyxPZkCdOHLnziCkAHbdmPdfBSqPti', 'Essabiri Soukaina', 'CONDUCTEUR', 'Utilisateur', NULL, '2026-06-05 10:39:20', NULL, 0, NULL);
...
ALTER TABLE `favori`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKkavfc8kgjg25kddukwow1l3wu` (`conducteur_id`);
...
ALTER TABLE `historique`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKi3watxo34shhrm2v07nd6bimi` (`conducteur_id`);
...
ALTER TABLE `signalement`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKh3iu3myfk5cgheaqc6tsga739` (`conducteur_id`);
...
--
ALTER TABLE `conducteur`
  ADD CONSTRAINT `FKal7j2r0orcjhc93a0tgrd22j1` FOREIGN KEY (`id`) REFERENCES `utilisateur` (`id`);
...
--
ALTER TABLE `favori`
  ADD CONSTRAINT `FKkavfc8kgjg25kddukwow1l3wu` FOREIGN KEY (`conducteur_id`) REFERENCES `conducteur` (`id`);

--
-- Contraintes pour la table `historique`
--
ALTER TABLE `historique`
  ADD CONSTRAINT `FKi3watxo34shhrm2v07nd6bimi` FOREIGN KEY (`conducteur_id`) REFERENCES `conducteur` (`id`);

--
-- Contraintes pour la table `signalement`
--
ALTER TABLE `signalement`
  ADD CONSTRAINT `FKh3iu3myfk5cgheaqc6tsga739` FOREIGN KEY (`conducteur_id`) REFERENCES `conducteur` (`id`);
COMMIT;
