    ...
    for station in stations:
        cursor.execute(
            ...
            INSERT INTO stations (
                ...
                disponibilite_temps_reel, derniere_maj_disponibilite, source_data
            )
            ...
            ON DUPLICATE KEY UPDATE
                ...
                disponibilite_temps_reel = VALUES(disponibilite_temps_reel),
                derniere_maj_disponibilite = VALUES(derniere_maj_disponibilite),
            ...
            (
                ...
                station.get("disponibilite_temps_reel"),
                station.get("derniere_maj_disponibilite"),
                station.get("source_data"),
            ),
        )
        cursor.execute(
