def transform_station(station):
    ...
    # --- Disponibilité réelle basée sur les données OCM ---
    ...
    if is_operational is True:
        ...
        disponibilite = "Inconnu"

    derniere_maj = station.get("DateLastStatusUpdate")
    ...
    return {
        ...
        "disponibilite_temps_reel": disponibilite,
        "derniere_maj_disponibilite": derniere_maj,
        "source_data": "OpenChargeMap",
    }
